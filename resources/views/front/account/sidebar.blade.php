<div class="card border-0 shadow mb-4 p-3">
    <div class="s-body text-center mt-3">
        @if(Auth::user()->image != '')
            <img src="{{ asset('profile_photo/'.Auth::user()->image) }}" alt="profile_photo"  class="rounded-circle img-fluid" style="width: 150px;">
        @else
            <img src="{{asset('assets/images/avatar7.png')}}" alt="profile_photo"  class="rounded-circle img-fluid" style="width: 150px;">
        @endif
